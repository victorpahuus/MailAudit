#!/bin/bash
# zone-tester7.sh — Enhanced Mail security checker (macOS/Bash 3 compatible)
...
Options:
  ...
  --check-relay      Perform safe open relay detection
  --verbose          Show additional details
  --include-cloud    Include Microsoft 365 / Google MX hosts in host-level tests
...
print_header() {
  echo
  echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
  echo -e "${CYAN}  $SHIELD  ${BOLD}Mail Security Scanner${NC}  ${DIM}${NC}"
  echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
}
...
is_microsoft365_host() {
  local host="$1"
  if echo "$host" | grep -qE "(mail\.protection\.outlook\.com|mail\.eo\.outlook\.com)$"; then
    return 0
  fi
  return 1
}

is_google_workspace_host() {
  local host="$1"
  if echo "$host" | grep -qE "(aspmx.*\.googlemail\.com|alt[1-4]\.aspmx.*\.googlemail\.com|smtp\.google\.com)$"; then
    return 0
  fi
  return 1
}

is_cloud_managed_host() {
  local host="$1"
